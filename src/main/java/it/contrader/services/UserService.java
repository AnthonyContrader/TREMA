...
public class UserService {
	...
	public UserDTO getUserByUserLoginAndPassword(String username, String password) {

		final User user = userRepository.findUserByUserLoginAndPassword(username, password);
