...
<body>
	<div class="center">
		...
		<form method="POST" action="/TREMA/ProjectServlet?richiesta=update">
			<br>
			...
			<br>
			<br>
			<a href="/TREMA/ProjectServlet?richiesta=project_manager"><i class="fas fa-arrow-alt-circle-left fa-lg"> Back</i></a>
		</form>
