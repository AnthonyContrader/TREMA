						...
						<div class="card-body card-block">
							<form action="/User/update" method="post">
								...
								<div class="form-group">
									<label>Project</label> <input class="au-input au-input--full"
										type="text" name="project" placeholder="Project"
										value="<%=updateProject.getProject()%>">
								</div>

								<div class="form-group">
									<label>Tipologie</label> <input class="au-input au-input--full"
										type=""tipologie"" name="tipologie" placeholder="Tipologie"
										value="<%=updateProject.getTipologie()%>">
								</div>
								<input type="hidden" name="iduser" value="<%=updateProject.getUserDTO()%>" />
