								...
								<div class="au-breadcrumb-content">
									<div class="au-breadcrumb-left">
										...
										<ul class="list-unstyled list-inline au-breadcrumb__list">
											...
											<li class="list-inline-item">Edit Material</li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="card-body card-block">
							<form action="/Material/update" method="post">
								<input type="hidden" name="id"
									value="<%=updateMaterial.getIdmaterial()%>" />
								<div class="form-group">
									<label>Material</label> <input class="au-input au-input--full"
										type="text" name="material" placeholder="Material"
										value="<%=updateMaterial.getMaterial()%>">
								</div>

								<div class="form-group">
									<label>Quantita</label> <input class="au-input au-input--full"
										type="text" name="material" placeholder="Material"
										value="<%=updateMaterial.getQuantita()%>">
								</div>
