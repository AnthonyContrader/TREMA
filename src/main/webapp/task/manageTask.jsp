										...
										<table class="table table-data2">
											...
											<tbody>
												...
												<tr class="tr-shadow">
													...
													<td><%=task.getTask()%></td>
													<td><%=task.getData_inizio()%></td>
													<td><%=task.getData_fine()%></td>
													<td><%=task.getObjective()%></td>
												<!--  <td><%=task.%></td>  da stampare i dipendenti reltivi al task-->	
													<td>
														<div class="table-data-feature">

															<a href="/Task/updateRedirect?id=<%=task.getIdTask()%>"
																class="item" data-toggle="tooltip" data-placement="top"
																title="Edit"> <i class="zmdi zmdi-edit"></i>
															</a> <a href="/Task/delete?id=<%=task.getIdTask()%>"
																class="item" data-toggle="tooltip" data-placement="top"
