...
<%
	...
	List<TaskDTO> taskList = (List<TaskDTO>) request.getAttribute("resourceList");
							...
							<form action="/Task/update" method="post">
								...
								<div class="form-group">
									<label>Resource</label> <select class="form-control"
										name="resource_id">
										<%
											for (TaskDTO resourceDTO : taskList) {

												if (resourceDTO.getIdTask() == updateTask.getDipendentiDTO().getResourceId()) {
										%>
								...
								<div class="form-group">
									<label>State</label> <input class="au-input au-input--full"
										type="number" name="task_state" placeholder="State"
										value="<%=updateTask.getTaskState()%>">
								</div>
